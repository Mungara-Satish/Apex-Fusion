    ...
    <header className="sticky top-0 z-40 w-full border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80">
      <div className="max-w-7xl mx-auto flex h-16 items-center justify-between px-4 sm:px-6 gap-4">
        ...
        <div className="flex items-center gap-4 xl:gap-6 shrink-0 min-w-max">
          <Link href={isLoggedIn ? dashboardUrl : '/'} className="flex items-center gap-2.5 font-bold text-lg sm:text-xl tracking-tight text-foreground shrink-0 whitespace-nowrap">
